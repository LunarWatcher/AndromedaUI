...
#include <andromeda/dom/elements.hpp>  // for operator|, text, Element, hbox, bold, color, filler, separator, vbox, window, gauge, Fit, size, dim, EQUAL, WIDTH
...
#include "andromeda/screen/color.hpp"  // for Color, Color::Green, Color::Red, Color::RedLight, andromeda
