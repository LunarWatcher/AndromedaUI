...
#include "andromeda/component/component.hpp"  // for Checkbox, Renderer, Horizontal, Vertical, Input, Menu, Radiobox, ResizableSplitLeft, Tab
#include "andromeda/component/component_base.hpp"  // for ComponentBase, Component
#include "andromeda/component/component_options.hpp"  // for MenuOption, InputOption
...
#include "andromeda/dom/elements.hpp"  // for text, color, operator|, bgcolor, filler, Element, vbox, size, hbox, separator, flex, window, graph, EQUAL, paragraph, WIDTH, hcenter, Elements, bold, vscroll_indicator, HEIGHT, flexbox, hflow, border, frame, flex_grow, gauge, paragraphAlignCenter, paragraphAlignJustify, paragraphAlignLeft, paragraphAlignRight, dim, spinner, LESS_THAN, center, yframe, GREATER_THAN
#include "andromeda/dom/flexbox_config.hpp"  // for FlexboxConfig
#include "andromeda/screen/color.hpp"  // for Color, Color::BlueLight, Color::RedLight, Color::Black, Color::Blue, Color::Cyan, Color::CyanLight, Color::GrayDark, Color::GrayLight, Color::Green, Color::GreenLight, Color::Magenta, Color::MagentaLight, Color::Red, Color::White, Color::Yellow, Color::YellowLight, Color::Default, Color::Palette256, andromeda
#include "andromeda/screen/color_info.hpp"  // for ColorInfo
#include "andromeda/screen/terminal.hpp"    // for Size, Dimensions
