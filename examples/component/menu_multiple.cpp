...
#include "andromeda/component/component.hpp"  // for Menu, Renderer, Horizontal, Vertical
...
#include "andromeda/dom/elements.hpp"  // for text, Element, operator|, window, flex, vbox

using namespace andromeda;

static Component Window(const std::string& title, const Component& component) {
