...
// the LICENSE file.
#ifndef ANDROMEDAUI_COMPONENT_BASE_HPP
#define ANDROMEDAUI_COMPONENT_BASE_HPP

#include <memory>  // for unique_ptr
#include <vector>  // for vector

#include "andromeda/component/captured_mouse.hpp"  // for CaptureMouse
#include "andromeda/dom/elements.hpp"              // for Element
...
/// @brief It implement rendering itself as andromeda::Element. It implement
/// keyboard navigation by responding to andromeda::Event.
/// @ingroup component
class ComponentBase {
 public:
...
#endif /* end of include guard: ANDROMEDAUI_COMPONENT_BASE_HPP */
