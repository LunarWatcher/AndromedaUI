...
#include <utility>
#include "andromeda/component/component.hpp"  // for Maybe, Checkbox, Make, Radiobox, Vertical, Dropdown
...
#include "andromeda/dom/elements.hpp"  // for operator|, Element, border, filler, operator|=, separator, size, text, vbox, frame, vscroll_indicator, hbox, HEIGHT, LESS_THAN, bold, inverted
#include "andromeda/screen/util.hpp"   // for clamp
#include "andromeda/util/ref.hpp"      // for ConstStringListRef
...
Component Dropdown(DropdownOption option) {
  class Impl : public ComponentBase, public DropdownOption {
   public:
    ...
    bool OnEvent(andromeda::Event event) override {
