...
// the LICENSE file.
#include <andromeda/component/component_options.hpp>  // for ResizableSplitOption
...
#include "andromeda/component/component.hpp"  // for Horizontal, Make, ResizableSplit, ResizableSplitBottom, ResizableSplitLeft, ResizableSplitRight, ResizableSplitTop
...
#include "andromeda/dom/elements.hpp"  // for operator|, reflect, Element, size, EQUAL, xflex, yflex, hbox, vbox, HEIGHT, WIDTH, text
