...
#include "andromeda/component/animation.hpp"  // for Animator, Params (ptr only)
#include "andromeda/component/component.hpp"  // for Make, Button
#include "andromeda/component/component_base.hpp"  // for ComponentBase
#include "andromeda/component/component_options.hpp"  // for ButtonOption, AnimatedColorOption, AnimatedColorsOption, EntryState
#include "andromeda/component/event.hpp"  // for Event, Event::Return
...
#include "andromeda/dom/elements.hpp"  // for operator|, Decorator, Element, operator|=, bgcolor, color, reflect, text, bold, border, inverted, nothing
