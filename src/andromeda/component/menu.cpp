...
#include "andromeda/component/animation.hpp"  // for Animator, Linear
#include "andromeda/component/component.hpp"  // for Make, Menu, MenuEntry, Toggle
#include "andromeda/component/component_base.hpp"     // for ComponentBase
#include "andromeda/component/component_options.hpp"  // for MenuOption, MenuEntryOption, UnderlineOption, AnimatedColorOption, AnimatedColorsOption, EntryState
#include "andromeda/component/event.hpp"  // for Event, Event::ArrowDown, Event::ArrowLeft, Event::ArrowRight, Event::ArrowUp, Event::End, Event::Home, Event::PageDown, Event::PageUp, Event::Return, Event::Tab, Event::TabReverse
#include "andromeda/component/mouse.hpp"  // for Mouse, Mouse::Left, Mouse::Released, Mouse::WheelDown, Mouse::WheelUp, Mouse::None
#include "andromeda/component/screen_interactive.hpp"  // for Component
#include "andromeda/dom/elements.hpp"  // for operator|, Element, reflect, Decorator, nothing, Elements, bgcolor, color, hbox, separatorHSelector, separatorVSelector, vbox, xflex, yflex, text, bold, focus, inverted, select
#include "andromeda/screen/box.hpp"    // for Box
#include "andromeda/screen/color.hpp"  // for Color
#include "andromeda/screen/util.hpp"   // for clamp
#include "andromeda/util/ref.hpp"  // for Ref, ConstStringListRef, ConstStringRef

namespace andromeda {

static Element DefaultOptionTransform(const EntryState& state) {
...
static bool IsInverted(Direction direction) {
    switch (direction) {
    case Direction::Up:
    case Direction::Left:
        return true;
...
public:
    ...
    bool IsHorizontal() { return andromeda::IsHorizontal(direction); }
    void OnChange() {
        if (on_change) {
            on_change();
        }
