...
#include "andromeda/component/component_base.hpp"  // for ComponentBase, Components
...
/// Build a andromeda::Element to be drawn on the andromeda::Screen representing this
/// andromeda::ComponentBase. Please override OnRender() to modify the rendering.
/// @ingroup component
...
/// @brief Draw the component.
/// Build a andromeda::Element to be drawn on the ftxi::Screen representing this
/// andromeda::ComponentBase. This function is means to be overridden.
/// @ingroup component
