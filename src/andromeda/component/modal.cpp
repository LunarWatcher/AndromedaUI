...
#include <andromeda/dom/elements.hpp>  // for operator|, Element, center, clear_under, dbox
#include <memory>                  // for __shared_ptr_access, shared_ptr
#include <utility>                 // for move

#include "andromeda/component/component.hpp"  // for Make, Tab, ComponentDecorator, Modal
