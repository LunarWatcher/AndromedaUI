...
#include "andromeda/component/captured_mouse.hpp"  // for CapturedMouse
#include "andromeda/component/component.hpp"       // for Make, Slider
#include "andromeda/component/component_base.hpp"  // for ComponentBase
#include "andromeda/component/event.hpp"  // for Event, Event::ArrowDown, Event::ArrowLeft, Event::ArrowRight, Event::ArrowUp
#include "andromeda/component/mouse.hpp"  // for Mouse, Mouse::Left, Mouse::Pressed, Mouse::Released
#include "andromeda/component/screen_interactive.hpp"  // for Component
#include "andromeda/dom/elements.hpp"  // for operator|, text, Element, xflex, hbox, color, underlined, reflect, Decorator, dim, vcenter, focus, nothing, select, yflex, gaugeDirection
#include "andromeda/screen/box.hpp"    // for Box
#include "andromeda/screen/color.hpp"  // for Color, Color::GrayDark, Color::White
#include "andromeda/util/ref.hpp"      // for ConstRef, Ref, ConstStringRef
...
public:
    explicit SliderBase(const SliderOption<T>& options) : SliderOption<T>(options) {}
...
template Component Slider(const SliderOption<int8_t>&);
template Component Slider(const SliderOption<int16_t>&);
template Component Slider(const SliderOption<int32_t>&);
template Component Slider(const SliderOption<int64_t>&);

template Component Slider(const SliderOption<uint8_t>&);
template Component Slider(const SliderOption<uint16_t>&);
template Component Slider(const SliderOption<uint32_t>&);
template Component Slider(const SliderOption<uint64_t>&);

template Component Slider(const SliderOption<float>&);
template Component Slider(const SliderOption<double>&);
