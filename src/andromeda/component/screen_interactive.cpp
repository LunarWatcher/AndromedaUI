...
#include <andromeda/component/task.hpp>  // for Task, Closure, AnimationTask
#include <andromeda/screen/screen.hpp>  // for Pixel, Screen::Cursor, Screen, Screen::Cursor::Hidden
...
#include "andromeda/component/animation.hpp"  // for TimePoint, Clock, Duration, Params, RequestAnimationFrame
#include "andromeda/component/captured_mouse.hpp"  // for CapturedMouse, CapturedMouseInterface
...
#include "andromeda/component/receiver.hpp"  // for ReceiverImpl, Sender, MakeReceiver, SenderImpl, Receiver
#include "andromeda/component/terminal_input_parser.hpp"  // for TerminalInputParser
#include "andromeda/dom/node.hpp"                         // for Node, Render
#include "andromeda/dom/requirement.hpp"                  // for Requirement
#include "andromeda/screen/pixel.hpp"                     // for Pixel
#include "andromeda/screen/terminal.hpp"                  // for Dimensions, Size
#include "andromeda/screen/util.hpp"                      // for util::clamp
...
void andromeda_on_resize(int columns, int rows) {
