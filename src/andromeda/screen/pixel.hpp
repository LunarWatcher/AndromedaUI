...
// the LICENSE file.
#ifndef ANDROMEDAUI_SCREEN_PIXEL_HPP
#define ANDROMEDAUI_SCREEN_PIXEL_HPP

#include <cstdint>                 // for uint8_t
#include <string>                  // for string, basic_string, allocator
#include "andromeda/screen/color.hpp"  // for Color, Color::Default
...
#endif  // ANDROMEDAUI_SCREEN_PIXEL_HPP
